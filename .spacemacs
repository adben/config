...
values."
  (setq-default
   ...
   ;; `+distribution'./path/to/dash-at-poinr  (add-hook 'lisp-mode-hook
   ;; #'enable-paredit-mode now available distributions are `spacemacs-base'
